      ...
      <section className="grid items-center gap-10 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <p className="text-lg text-neutral-700">
            Create an album, apply a theme, and instantly get beautiful, on‑brand images to share
        ...
        <div className="animate-fade-in grid grid-cols-3 gap-3">
          ...
          <div className="col-span-2 aspect-[16/10] overflow-hidden rounded-xl bg-neutral-200"></div>
