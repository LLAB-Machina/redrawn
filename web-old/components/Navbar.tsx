    ...
    <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <Container>
        <nav className="flex h-14 items-center gap-4">
          ...
          <Link className="text-sm text-neutral-700 hover:text-black" href="/app">
            App
          </Link>
          <Link className="text-sm text-neutral-700 hover:text-black" href="/app/themes">
            Themes
          </Link>
          <Link className="text-sm text-neutral-700 hover:text-black" href="/billing">
            Billing
          </Link>
          {isAdmin && (
            <Link className="text-sm text-neutral-700 hover:text-black" href="/admin/prices">
              Admin
            </Link>
          )}
          <button
