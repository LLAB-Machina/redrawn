...
type riverJobTable struct {
	...
	UniqueKey    postgres.ColumnBytea
...
func newRiverJobTableImpl(schemaName, tableName, alias string) riverJobTable {
	var (
		...
		UniqueKeyColumn    = postgres.ByteaColumn("unique_key")
		...
		defaultColumns     = postgres.ColumnList{IDColumn, StateColumn, AttemptColumn, CreatedAtColumn, ScheduledAtColumn, PriorityColumn, MetadataColumn, QueueColumn, TagsColumn}
	)
