...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			albuminvite.Table:     albuminvite.ValidColumn,
			albuminvitelink.Table: albuminvitelink.ValidColumn,
			albumpassword.Table:   albumpassword.ValidColumn,
			albumuser.Table:       albumuser.ValidColumn,
			creditusage.Table:     creditusage.ValidColumn,
			file.Table:            file.ValidColumn,
			generatedphoto.Table:  generatedphoto.ValidColumn,
			originalphoto.Table:   originalphoto.ValidColumn,
