...
### Note
The `api/ent` directory is generated by Ent with `make code-gen`, but the `api/ent/schema` directory defines the DB schema and is the source of the generation. A bit confusing.
